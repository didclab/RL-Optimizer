...
class environmentGroupValidation:
    def __init__(self,
                ...
                self.a_group=self.grouped_df.get_group(self.group_key)
                ...
                self.group_identification=self.group_key
                ...
                for key in self.group_from_grouped_df.groups.keys():
                    ...
                    self.state_list.append([self.group_key[0],self.group_key[1],self.group_key[2],self.group_key[3],self.group_key[4],key[0],key[1],key[2]]) #,key[3],key[4]
    """
    input:
    output:provides the maximum throughput for the class groupkey
    """
